...
describe("ERC1155WithERC20", function () {
  beforeEach(async function () {
    [this.deployer, this.addr1, this.addr2, this.addr3] = await ethers.getSigners();
  ...
  it("mints id 0 as ERC20 and tracks supply", async function () {
    await this.token.mint(this.addr1.address, 0, 100, "0x");
  ...
  it("burns id 0 and updates ERC20 supply", async function () {
    await this.token.mint(this.addr1.address, 0, 50, "0x");
  ...
  it("processes non-zero ids as ERC1155 tokens", async function () {
    await this.token.mint(this.addr1.address, 1, 10, "0x");
